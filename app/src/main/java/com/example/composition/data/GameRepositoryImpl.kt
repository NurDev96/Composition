...
object GameRepositoryImpl : GameRepository {
    ...
    override fun generateQuestions(maxSumValue: Int, countOfOptions: Int): Question {
        val sum = Random.nextInt(MIN_SUM_VALUE, maxSumValue + 1) // случ знач  // 7
        val visibleNumber = Random.nextInt(MIN_ANSWER_VALUE, sum)  // изуально видный вариянт/ 4 + ?
        val options = HashSet<Int>()
        val rightAnswers = sum - visibleNumber // 4 + 3 тут находим прав номер "3"
